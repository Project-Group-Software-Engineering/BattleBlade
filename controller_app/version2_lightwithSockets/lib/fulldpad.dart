      ...
      child:Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              DPadButton(index: 0, icon: Icons.arrow_drop_up, player:1, control:3 ,),
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              DPadButton(index: 1, icon: Icons.arrow_left, player:1, control:1),
              SizedBox(width: 40), // Adjust spacing
              DPadButton(index: 2, icon: Icons.arrow_right, player:1, control:2),
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              DPadButton(index: 3,icon: Icons.arrow_drop_down, player:1, control:7),
            ],
          ),
        ],
      ),
